...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/lion/css/reset.min.css">
...
<#--标题栏-->
<nav class="navbar navbar-inverse navbar-inner" role="navigation" style="margin-bottom: 0px; margin-bottom: 0px;">
    <div class="navbar-header" style="width: max-content">
        <a class="navbar-brand" >北京化工大学数字媒体专业主页</a>
    </div>
    <div style="margin-bottom: 0px; padding-bottom: 0px;">
        <ul class="nav nav-tabs" id="myTab">
            <li><a style="color: aliceblue" href="#home">学院新闻</a></li>
            <li><a style="color: aliceblue" href="#domain">学院通知</a></li>
                <#if Session.isTeacher?exists>
                        <#if Session.isTeacher=="0">
                        <li><a style="color: aliceblue" href="/scanusers">查看个人作品</a></li>
                        <li><a style="color: aliceblue" href="/stuupload">作品提交</a></li>
                        <#elseif Session.isTeacher=="1">
                        <li><a style="color: aliceblue" href="/scanusers">查看个人作品</a></li>
                        <li><a style="color: aliceblue" href="#domain">作业审批</a></li>
                        <li><a style="color: aliceblue" href="/stuupload">作品提交</a></li>
                        <#else>
                            <li></li>
                        </#if>
            ...
            <li class="pull-right"><a style="color: aliceblue">
                <#if Session.welcomeuser?exists>
            ...
            <li class="pull-right">
                <#if Session.welcomeuser?exists>
                    <a href="/logout.do" style="color: aliceblue">注销 </a>
                <#else>
                    <a href="/login" style="color: aliceblue">登陆 </a>
                </#if>
                 </li>
        </ul>
    </div>
...
<script type="text/javascript" src="/static/main_pic/js/TweenMax.min.js"></script>
<script type="text/javascript" src="/static/main_pic/js/Stats.min.js"></script>
